...
- AI-assisted log analysis using Amazon CloudWatch Logs
- Natural language querying of API errors, audit logs, and monitoring events
- Log summarization using Amazon Bedrock
